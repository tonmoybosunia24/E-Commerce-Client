                     ...
                     <div className='flex justify-center lg:justify-between text-gray-500 text-sm border-b border-gray-300 px-5 md:px-10 lg:px-20 py-2'>
                            ...
                            <div className='flex gap-2'>
                                   ...
                                   <div className="relative border-r border-gray-300 pr-2">
                                          ...
                                          <ul tabIndex={0} className={`absolute left-1/2 transform  -translate-x-1/2 z-30 w-40 p-2 shadow-md mt-3 transition-all delay-75 duration-500 ease-in-out bg-white ${languageOpen ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-5"} border border-t-0 border-gray-300 space-y-1`}>
