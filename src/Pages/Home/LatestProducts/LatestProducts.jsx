...
const LatestProducts = () => {
    ...
    const [products, productsLoading] = useCategoryProducts(`?isNewArrival=true`);

    return (
        <section className="px-5 md:px-10 lg:px-20 my-5 md:my-7 lg:my-10">
            {/* -----------------Title And Slider Navigation----------------- */}
            <div className='flex justify-between items-center mb-3'>
                <h2 className='font-semibold text-base md:text-xl lg:text-2xl hover:text-Radical'>Latest Products</h2>
