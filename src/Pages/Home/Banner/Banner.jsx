       ...
       return (
              <section className='bg-aliceBlue py-5 px-5 md:px-10 lg:px-20'>
                     ...
                     <div className='flex flex-col lg:flex-row gap-5'>
                            ...
                            >
                                   {/* -------------------Swiper Navigation---------------- */}
                                   <div className='absolute top-1/2 -translate-y-1/2 left-2 lg:left-5 cursor-pointer z-10'><IoIosArrowDropleftCircle className='Prev  text-2xl lg:text-4xl text-Radical' /></div>
                                   <div className='absolute top-1/2 -translate-y-1/2 right-2 lg:right-5 cursor-pointer z-10'><IoIosArrowDroprightCircle className='Next  text-2xl lg:text-4xl text-Radical' /></div>
                                   {/* ---------------------Swiper Banner------------------ */}
                                   <SwiperSlide className='relative'>
                                          <img className='w-full h-full object-cover rounded-md' src={banner1} alt="" />
                                          <div className='absolute top-1/2 transform -translate-y-1/2 right-5 md:right-10 lg:right-10 space-y-1 md:space-y-2 lg:space-y-2'>
                                                 <h4 className='font-medium text-xs md:text-xl lg:text-2xl'>Big Saving Days Sale</h4>
                                                 <h2 className='font-medium text-sm md:text-3xl lg:text-4xl'>Women Solid Round <br /> Green T-Shirt</h2>
                                                 <p className='text-xs md:text-xl lg:text-2xl'>Starting At Only <span className='font-bold text-Radical text-md lg:text-3xl'>$59.00</span></p>
                                                 <button className='font-medium bg-Radical hover:bg-black text-white text-xs lg:text-sm px-2 lg:px-6 py-1 lg:py-2 rounded-xs lg:rounded-md cursor-pointer'>Shop Now</button>
                                          </div>
                                   </SwiperSlide>
                                   <SwiperSlide>
                                          <img className='w-full h-full object-cover rounded-md' src={banner2} alt="" />
                                          <div className='absolute top-1/2 transform -translate-y-1/2 right-5 md:right-10 lg:right-10 space-y-1 md:space-y-2 lg:space-y-2'>
                                                 <h4 className='font-medium text-xs md:text-xl lg:text-2xl'>Big Saving Days Sale</h4>
                                                 <h2 className='font-medium text-sm md:text-3xl lg:text-4xl'>Buy Modern Chair In <br /> Black Color</h2>
                                                 <p className='text-xs md:text-xl lg:text-2xl'>Starting At Only <span className='font-bold text-Radical text-md lg:text-3xl'>$99.00</span></p>
                                                 <button className='font-medium bg-Radical hover:bg-black text-white text-xs lg:text-sm px-2 lg:px-6 py-1 lg:py-2 rounded-xs lg:rounded-md cursor-pointer'>Shop Now</button>
                                          </div>
                                   </SwiperSlide>
                            </Swiper>
                            ...
                            <div className='hidden md:flex lg:flex md:flex-row lg:flex-col gap-5'>
                                   <div className='flex-1 relative overflow-hidden rounded-md group'>
                                          <img className='w-full transition-transform duration-1000 ease-in-out transform group-hover:scale-110' src={subBanner1} alt="" />
                                          <div className='absolute top-1/2 transform -translate-y-1/2 left-5 space-y-0.5'>
                                                 <h3 className='font-semibold text-xl'>Samsung Gear <br /> VR Camera</h3>
                                                 <p className='font-bold text-xl text-Radical'>$129.00</p>
                                                 <button className='text-sm font-semibold underline cursor-pointer'>SHOP NOW</button>
                                          </div>
                                   </div>
                                   <div className='flex-1 relative overflow-hidden rounded-md group'>
                                          <img className='w-full transition-transform duration-1000 ease-in-out transform group-hover:scale-110' src={subBanner2} alt="" />
                                          <div className='absolute top-1/2 transform -translate-y-1/2 right-5 space-y-0.5'>
                                                 <h3 className='font-semibold text-xl'>Marcel Dining <br /> Room Chair</h3>
                                                 <p className='font-bold text-xl text-Radical'>$129.00</p>
                                                 <button className='text-sm font-semibold underline cursor-pointer'>SHOP NOW</button>
                                          </div>
                                   </div>
                            ...
                            <div className='flex flex-col gap-3 md:hidden lg:hidden '>
                                   <div className='relative overflow-hidden rounded-md group'>
                                          <img className='w-full transition-transform duration-1000 ease-in-out transform group-hover:scale-110' src={subBanner3} alt="" />
                                          <div className='absolute top-1/2 transform -translate-y-1/2 left-5 space-y-0.5'>
                                                 <h3 className='font-semibold text-2xl'>Samsung Gear <br /> VR Camera</h3>
                                                 <p className='font-bold text-xl text-Radical'>$129.00</p>
                                                 <button className='font-semibold underline cursor-pointer'>SHOP NOW</button>
                                          </div>
                                   </div>
                                   <div className='relative overflow-hidden rounded-md group'>
                                          <img className='w-full transition-transform duration-1000 ease-in-out transform group-hover:scale-110' src={subBanner4} alt="" />
                                          <div className='absolute top-1/2 transform -translate-y-1/2 right-5 space-y-0.5'>
                                                 <h3 className='font-semibold text-2xl'>Marcel Dining <br /> Room Chair</h3>
                                                 <p className='font-bold text-xl text-Radical'>$129.00</p>
                                                 <button className='font-semibold underline cursor-pointer'>SHOP NOW</button>
                                          </div>
                                   </div>
